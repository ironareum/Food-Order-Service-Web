...
<body>
 ...
 제1장 총칙
 <br /><br />
 &nbsp;&nbsp; 제1조(목적) 이 약관은 회사(어서오고)가 온라인으로 제공하는 디지털콘텐츠(이하 "콘텐츠"라고 한다) 및 제반서비스의 이용과 관련하여 회사와 이용자와의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다.
...
<div id=check align="center">
 <a href="${root}Customer/new" class="btn btn-primary">동의</a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="${root}Customer/login" class="btn btn-primary" onclick="
